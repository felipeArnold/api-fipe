...
try {
    ...
    $marcas = Cars::getBrands();
    if ($codMarca) {
        $modelos = Cars::getModelsBrands($codMarca);
        ...
        if ($codModelo) {
            $anos = Cars::getYearsBrands($codMarca, $codModelo);
            if (!$anos) {
        ...
        if ($codAno) {
            $veiculo = Cars::getVehicle($codMarca, $codModelo, $codAno);
            if (!$veiculo) {
